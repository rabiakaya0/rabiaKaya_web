...
from pages.views import IndexView, WhoView, ElectricView, ElectronicView, SoftwareUnityView, SoftwareDjangoView, ContactView
...
urlpatterns = [
    ...
    path('/iletisim', ContactView.as_view(), name="iletisim"),
]